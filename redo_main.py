...
def payment():
    ...
    total_days = terms * 30
    days_to_first = int(days_to_entry.get())
    ...
    total_financed_per_day_no_interest = total_financed/total_days
    total_interest_payed = total_financed * apr
    int_per_day = total_interest_payed/total_days
    final_per_day = total_financed_per_day_no_interest + int_per_day
    total_amount_payed = total_financed + total_interest_payed
    monthly = days_to_first * final_per_day
